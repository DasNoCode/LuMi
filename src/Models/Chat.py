...
class Chat(MongoModel):
    ...
    whos_that_pokemon: bool = fields.BooleanField(required=True, default=False)
    ...
    warns: List[Dict[str, object]] = fields.ListField(blank=True,default=list)
    banned_users: List[Dict[str, object]] = fields.ListField(default=list)
